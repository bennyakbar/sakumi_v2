...
<head>
    ...
    <style>
        :root {
            --ink: #0f172a; --muted: #64748b; --line: #cbd5e1; --soft: #f8fafc;
            --brand-1: #7a2e0c; --brand-2: #c2410c; --brand-3: #fff7ed; --ok: #9a3412;
        }
        * { box-sizing: border-box; }
        ...
        .sheet { min-height: 136mm; max-height: 136mm; border: 1px solid #94a3b8; border-radius: 8px; overflow: hidden; display: flex; flex-direction: column; position: relative; }
        .dynamic-watermark { position: absolute; top: 52%; left: 50%; transform: translate(-50%, -50%) rotate(-24deg); font-family: "IBM Plex Sans", "Inter", "Segoe UI", Tahoma, Arial, sans-serif; font-weight: 500; font-size: 20px; letter-spacing: 0.8px; color: rgba(15, 23, 42, 0.08); white-space: nowrap; pointer-events: none; z-index: 0; }
        .topbar { padding: 2.5mm 4mm; color: #fff; background: linear-gradient(120deg, var(--brand-1), var(--brand-2)); display: grid; grid-template-columns: 14mm 1fr 14mm; align-items: center; gap: 3mm; }
        ...
        th { background: var(--brand-3); color: #9a3412; font-size: 8px; text-transform: uppercase; letter-spacing: 0.35px; font-weight: 700; }
        ...
        .total-box { min-width: 56mm; border: 1px solid #fdba74; border-radius: 6px; overflow: hidden; }
        .total-head { background: #fff7ed; padding: 1.3mm 2mm; font-size: 8px; color: #c2410c; text-transform: uppercase; letter-spacing: 0.3px; font-weight: 700; }
    ...
    <main class="sheet">
        ...
        <section class="body">
            ...
            <section class="footer">
                <div class="foot-note">
                    {{ __('receipt.footer.official_expense') }}<br>
