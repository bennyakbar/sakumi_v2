...
<head>
    ...
    <style>
        ...
        * {
        ...
        .summary-row td { background: #f1f7fb; color: #2f4d61; font-style: italic; }
        .footer { display: grid; grid-template-columns: 1fr auto; gap: 3mm; align-items: end; }
        .foot-note { color: var(--muted); font-size: 8.2px; }
        .total-box { min-width: 56mm; border: 1px solid #84b3c9; border-radius: 6px; overflow: hidden; }
        .total-head { background: #e7f2f9; padding: 1.3mm 2mm; font-size: 8px; color: var(--brand-1); text-transform: uppercase; letter-spacing: 0.3px; font-weight: 700; }
